<?php
	...
	$query = "SELECT username, fullname, email, password,outside,id_outside,gender,dateofbirth FROM tblaccount WHERE outside=? AND id_outside =?";
	...
	*/
	...
	while($row = $data->fetch_assoc()){
		$account=new Account($row['username'], $row['fullname'],$row['email'],$row['password']);
