...
public class AdapterShared extends RecyclerView.Adapter<AdapterShared.ViewHolder> {
    SharedFragment context;
    List<NoteShared> notebooks;

    public AdapterShared(SharedFragment context, List<NoteShared> notebooks) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new AdapterShared.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull AdapterShared.ViewHolder holder, int position) {
